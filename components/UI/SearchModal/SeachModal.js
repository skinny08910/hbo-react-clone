  ...
  useEffect(async () => {
    try {
      let popData = await axios.get(
        "https://api.themoviedb.org/3/discover/movie?primary_release_year=2021&api_key=60251a68751bc8e49e5c42142c15ea73&language=en-US"
      );
  ...
  const handleInput = async (e) => {
    try {
      ...
      let searchData = await axios.get(
        `https://api.themoviedb.org/3/search/multi?query=${e.target.value}&api_key=60251a68751bc8e49e5c42142c15ea73&language=en-US`
      );
